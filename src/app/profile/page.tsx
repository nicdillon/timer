    ...
    <div className="flex flex-col items-center justify-center h-screen w-screen">
      {user && (
        <div className="p-10 text-center flex flex-col justify-center w-auto min-w-1/2 items-center bg-white bg-opacity-90 rounded-lg shadow-lg text-2xl h-auto text-black gap-4">
          ...
          <Link prefetch={false} className="block text-cyan-500 hover:text-cyan-700  rounded px-4 py-2 text-center " href="/api/auth/logout">Logout</Link>
        </div>
      )}
      {!user && (
        <div className="p-10 m-10 text-center flex flex-col justify-center w-auto max-w-1/2 items-center bg-white bg-opacity-90 rounded-lg shadow-lg text-2xl h-auto text-black gap-4">
          ...
          <Link prefetch={false} className="w-auto text-cyan-500 hover:text-cyan-700 border border-cyan-500 rounded px-4 py-2 text-center bg-white bg-opacity-30 backdrop-blur-md shadow-lg" href="/api/auth/login">Login</Link>
        </div>)}
    </div>
  );
}