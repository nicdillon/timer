...
export const metadata = {
  ...
  description: 'TIMER helps you boost productivity with customizable timers, task tracking, and focus management tools.',
      ...
      <main className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h1 className="text-6xl font-bold mb-6">
            Master Your Time with <span className="text-blue-500">TIMER</span>
          </h1>
          <p className="text-xl text-gray-300 mb-8">
            The smart time management tool that helps you stay focused and boost productivity
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="p-6 rounded-lg bg-gray-800">
            ...
            <p className="text-gray-300">Create personalized timers for any task or activity</p>
          </div>
          <div className="p-6 rounded-lg bg-gray-800">
            <h2 className="text-xl font-bold mb-4">Focus Tracking</h2>
            <p className="text-gray-300">Monitor your productivity and focus sessions</p>
          </div>
          <div className="p-6 rounded-lg bg-gray-800">
